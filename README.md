...
The example is using default password and port and make the share <u>visible</u> with default share name

	jdss-api-tools.exe clone --pool=Pool-0 --volume=vol00 --visible --node=192.168.0.220

The following examples are using default password and port and make the shares <u>invisible</u>
